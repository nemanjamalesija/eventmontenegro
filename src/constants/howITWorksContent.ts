...
export const contentSerbianHowItWorks = {
  ...
  paragraph2:
    'Izaberite iz našeg obimnog izbora vrhunske opreme i dekoracije za događaje i pronađite savršene elemente za oživljavanje Vašeg događaja. Takođe, ako Vam je potrebna pomoć u organizaciji događaja, naš stručni tim može se pozabaviti logistikom, koordinacijom i ostalim sitnicama.',
  paragraph3:
    'Prepustite se i uživajte u bezbrižnom slavlju, dok mi brinemo o svim detaljima. Bez obzira da li se odlučite za iznajmljivanje opreme ili ipak želite da nam povjerite i kompletnu organizaciju, mi smo tu da Vam pružimo sve što je potrebno za nezaboravno iskustvo.',
};
